...
<footer>
    <div class="footer-area padding-90px-tb md-padding-70px-tb sm-padding-50px-tb">
        <div class="container">
                ...
                <div class="col-lg-4 col-sm-6 sm-margin-40px-bottom">
                    ...
                    <ul class="list-style-1 no-margin">
                        <li>
                            ...
                            <span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">JDIH DPRD Wonosobo</span>
			    <span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-35px-left">Jl. Soekarno Hatta No.6 Wonosobo</span>
                        </li>
                        <li>
                            <span class="d-inline-block vertical-align-top font-size18"><i class="ti-mobile text-theme-color"></i></span>
                            <span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">(0286) 321546</span>
                        </li>
                        <li>
                            <span class="d-inline-block vertical-align-top font-size18"><i class="ti-email text-theme-color"></i></span>
                            <span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">setwan@wonosobokab.go.id</span>
                        </li>
                    </ul>
                </div>
			...
			<li><a href="https://jdih.wonosobokab.go.id/">Portal JDIH Kabupaten Wonosobo</a></li>
                    </ul>
                </div>
